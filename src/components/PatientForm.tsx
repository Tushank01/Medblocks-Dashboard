...
const PatientForm = ({ onSuccess }: PatientFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Log the data before sending to help with debugging
      ...
      setFormError("There was a problem registering the patient. Don't worry - your data has been safely stored and will be available.");
      
      toast({
        variant: "destructive",
        title: "Error",
        description: `Failed to register patient: ${error instanceof Error ? error.message : 'Unknown error'}`,
      });
    } finally {
      setLoading(false);
    }
